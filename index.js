...
// NOTE: Deliberately namespaced away from the shared 'summaryception' key used
// by the original extension and other community forks. This prevents this copy
// from reading/writing the same extensionSettings/chatMetadata entry as any other
// Summaryception-family extension you may also have installed, so resetting or
// reinstalling one no longer clobbers the other's settings or memory.
const MODULE_NAME = 'summaryception_eteitaxiv_fork';
